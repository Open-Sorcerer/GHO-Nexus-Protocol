...
contract Balance {
    ...
    function lendToken(address _token, uint256 _amount, uint64 destinationChainSelector,
        address receiver, PayFeesIn payFeesIn) public onlyAllowedTokens(_token) {
        ...
        Client.EVM2AnyMessage memory message = Client.EVM2AnyMessage({
            ...
            data: abi.encodeWithSignature("lend(address,uint256)", _token,_amount),
    ...
    function BorrowTokenMessage(address _token, uint256 _amount, uint64 destinationChainSelector, address receiver, PayFeesIn payFeesIn) public onlyAllowedTokens(_token) {
