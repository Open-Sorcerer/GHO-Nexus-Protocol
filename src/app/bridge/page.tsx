...
const chainList = [{
    symbol: 'Solana', image: 'https://statics.mayan.finance/assets/SOL.png', alt: 'Solana'
}, {symbol: 'Ethereum', image: 'https://statics.mayan.finance/assets/eth.png', alt: 'Ethereum'}, {
    symbol: 'BSC', image: 'https://statics.mayan.finance/assets/bsc.png', alt: 'BSC'
}, {
    symbol: 'Polygon', image: 'https://statics.mayan.finance/assets/polygon.png', alt: 'Polygon'
}, {
    symbol: 'Avalanche', image: 'https://statics.mayan.finance/assets/avax-icon.png', alt: 'Avalanche'
    ...
    return (
        <div
            ...
            <div className="w-7/12 h-full flex flex-col justify-evenly items-center">
                <div
                    className="w-full h-full flex flex-col bg-white border shadow-sm rounded-xl py-3 px-4 md:py-4 md:px-5 mb-5">
                    <div className="w-full h-full flex flex-row justify-between items-center gap-16 mb-8">
                        ...
                        <div className="w-5/12 h-full flex flex-col justify-between items-start gap-3">
                            ...
                            <div className="w-full hs-dropdown relative inline-flex">
                                ...
                                <ul className="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 w-56 hidden z-10 mt-2 min-w-[15rem] bg-white shadow-md rounded-lg p-2"
                                    ...
                                    {chainList.map((chain) => (
                                        <li key={chain.symbol} onClick={() => setFromChain(chain)}
                        ...
                        <div className="w-full h-full flex flex-col justify-end items-center gap-2 relative">
                            ...
                            <div className="w-full h-16 flex justify-end items-center">
                                {/* Amount TextBox */}
                                <div
                                    className="w-3/4 h-full flex py-2 px-3 bg-white border border-gray-200 rounded-l-lg">
                            ...
                            <div className="flex w-full gap-4 justify-start items-center">
                                <span className="flex items-center group-active:bg-gray-900/50 whitespace-nowrap">
                                    <input
                                        ...
                                        type="checkbox" checked={isAnotherWallet} id="hs-default-checkbox"
                                        onChange={() => setIsAnotherWallet(!isAnotherWallet)}/>
                                    <label htmlFor="hs-default-checkbox"
                                           className="text-sm text-gray-500 ms-3">Send to another Wallet</label>
                                </span>

                                    <input type="text"
                                           className={`${!isAnotherWallet&&"invisible"} py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none`}
